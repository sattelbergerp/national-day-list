...
march_7th.url = "http://www.nationaldaycalendar.com/national-cereal-day-march-7/"

march_7th_summary = NationalDay.new({})
march_7th_summary.name = "National Cereal Day"
march_7th_summary.url = "http://www.nationaldaycalendar.com/national-cereal-day-march-7/"
...
describe "NationalDayApi" do
	...
	describe '#is_cached' do
		it 'Returns the correct cache state for string "march"' do
			expect(api.is_cached("march")).to eq(true)
		end
		it 'Returns the correct cache state for string "3"' do
			expect(api.is_cached("3")).to eq(true)
		end
		it 'Returns the correct cache state for integer 2' do
			expect(api.is_cached(2)).to eq(true)
		end
	end
	...
	describe '#clear_cache' do
		it 'Clears the cache' do
			api.clear_cache
			expect(api.is_cached("march")).to eq(false)
		end
	end
...
describe "NationalDay" do
	...
	describe "#add_details" do
		it "Grabs summary information and sets has_details to true"
